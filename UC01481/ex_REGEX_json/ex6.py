...
with open("E:/DEV/Rodrigo_Freitas_CISEG1025/UC01481/ex_REGEX_json/nomes_emails.txt", "w") as ficheiroTxt:
    for registo in listaValidos:
        ficheiroTxt.write("nome: " + registo["nome"] + "\n")
        ficheiroTxt.write("email: " + registo["email"] + "\n")
        ficheiroTxt.write("\n")
